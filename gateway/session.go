...
// dropped (dropped strokes show as gappy remote drawings). Tunable via env
// SEND_BUFFER (default 1024) so it can be swept (1024/2048/4096) without a
// rebuild. NOTE: too large a buffer trades drops for latency (strokes arrive
// smooth but late) — sweep to find the sweet spot.
